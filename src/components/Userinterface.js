...
export default function () {
  ...
  return (
    <div className='react' >
      <div className="main">
        <div className="navbar-confirmation">
          <span className="netflix-logo-gs1">
            <img src={logo} className="img-netflixlogo-userinterface" alt="" />
            <span className="topics-userinterface-box">
              <span className="topic-userinterface-1 topics-userinterface">Home</span>
              <span className="topic-userinterface-2 topics-userinterface">TV Shows</span>
              <span className="topic-userinterface-3 topics-userinterface">Movies</span>
              <span className="topic-userinterface-4 topics-userinterface">New & Popular</span>
              <span className="topic-userinterface-5 topics-userinterface">My List</span>
              <span className="topic-userinterface-6 topics-userinterface">Browse by languages</span>
            </span>
          </span>

          <span className="userinterface-rightcorner">
            <span className="youraccount-img-box"><img className='youraccount-img' id='youraccount-img' src= {youraccount} alt="" /></span>
            <span className="dropdowncontent-account">
              <span className="dropdowncontent-1 dropdown">{location.state.email}</span>
              <span className="dropdowncontent-2 dropdown" onClick={updatepassword}>Change password</span>
              <Link to="/"><span className="dropdowncontent-3 dropdown">Sign out</span></Link>
            </span>
          </span>
        </div>
